...
export class ToolRegistry {
  ...
  previewAdmission(name: string, input: unknown, context: ToolContext): ToolAdmission {
  ...
  async execute(
    ...
    const { definition: tool, input: parsed } = this.previewAdmission(name, input, context);
